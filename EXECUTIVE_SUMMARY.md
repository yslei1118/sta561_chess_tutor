...
Our adaptive feedback system learns faster than rigid alternatives. Compared to a strategy that picks feedback at random, our system gives better-matched feedback about twelve percent more often. Compared to hand-written rules, it adapts to contexts the rules never anticipated. The improvement accumulates over time: the longer the student plays, the better-tuned the feedback becomes.
