...
results = run_experiment(students, policies, n_episodes=300, n_interactions_per_episode=30)
...
ax.set_title('Cumulative Regret by Policy (300 episodes, mean ± 2 SEM)', fontsize=13)
